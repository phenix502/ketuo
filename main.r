...
# y是最优点，一般选用y=b
# 描述侧距
ceju <- function(x, a=28553.5, b=73872.3){
  if(x < b) result <- a - x
...
# 表示x 与 满意范围之距
distance.good <- function(x, a=28553.5, b=73872.3){
...
# 表示x 与 可接受范围之距
distance.notbad <- function(x, c=7334.8, d=210614.6){
...
D <- function(x,a=28553.5, b=73872.3,c=7334.8, d=210614.6){
